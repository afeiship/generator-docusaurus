...
module.exports = class extends Generator {
    ...
    this.log(
      yosay(
        `Welcome to the stunning ${chalk.red(
          "generator-generator-docusaurus"
        )} generator!`
      )
    );
  ...
  writing() {
    ...
    remote("afeiship", "boilerplate-docusaurus", (_, cachePath) => {
      this.fs.copy(
    ...
    replace.sync({
      files,
      from: [
        /boilerplate-docusaurus-description/g,
        /boilerplate-docusaurus/g,
        /boilerplate-scope/g,
        /GeneratorDocusaurus/g
      ],
